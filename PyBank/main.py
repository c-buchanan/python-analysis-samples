...
print("Greatest Increase in Profits: $"+ str(max_rev_change), str(max_rev_change_date))
print("Greatest Decrease in Profits : $" +str(min_rev_change), str(min_rev_change_date)) 
...
with open("Financial_Analysis.txt", "w+") as text_file:
    ...
    print(f"Greatest Increase in Profits: ${max_rev_change} ({max_rev_change_date})", file=text_file)
    print(f"Greatest Decrease in Profits: ${min_rev_change} ({min_rev_change_date})", file=text_file) 
